        ...
        <div className="row g-5 mt-3">
              ...
              {sectionA &&
                sectionA.map((item, index) => {
                  return (
                    <div className="col-1">
                      <div
                        style={{ height: "80px",textAlign:'center',paddingTop:'30px' }}
                        key={index}
                        className={`${
                          item.selected ? " bg-success" : "bg-warning"
                        } `}
                        onClick={() => {
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Footer>
              ...
              <Button className='btn btn-dark' variant="primary" onClick={removeCompany}>
                OK
              </Button>
            </Modal.Footer>
          </Modal>
